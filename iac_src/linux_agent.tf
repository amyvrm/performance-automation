...
#			"python3 src/team_msg.py --scenario ${var.scenario} --webhook False --jenkins_url ${var.jenkins_url} --build_user ${var.build_user} --stats ${var.stats} --graph ${var.graph} --nexus_url ${var.nexus_url} --pipeline_num ${var.pipeline_num}"
		]
	}
