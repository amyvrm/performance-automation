...
class PerformanceScenario(PerfCommon):
    def __init__(self, machine_info, ver, access_key, secret_key, stats, graph, path_json, nexus_uname, nexus_pwd, scenario):
        ...
        sip, s_priv_ip = "99.79.38.2", "172.31.22.228"
        ...
        cip, c_priv_ip = "3.96.128.48", "172.31.31.189"
        ...
        spwd = "UI27RiLpb3?rNCE;qBg(rig=v!wldk&m"
        cpwd = "wutAY@WJAfsk6uO*U7On)SrnnKCkO6sl"
