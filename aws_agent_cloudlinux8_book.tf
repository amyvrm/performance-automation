resource "aws_instance" "dsa_cloudlinux8_machine" {
	
	ami = "${var.dsa_cloudlinux8_ami}"
	...
	tags = {
		Name = "${local.dsa_cloudlinux8_machine_name}"
...
output "dsa-cloudlinux8-id" {
  value = "${aws_instance.dsa_cloudlinux8_machine.id}"
}
