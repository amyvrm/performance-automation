...
FILENAME="/WindowsAgentDeploymentScript.ps1"
...
$managerUrl="https://$DSM_MACHINE_IP:4119/"
...
#& $Env:ProgramFiles"\Trend Micro\Deep Security Agent\dsa_control" -a dsm://172.31.24.206:4120/
