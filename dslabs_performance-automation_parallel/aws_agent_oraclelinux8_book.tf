resource "aws_instance" "dsa_oraclelinux8_machine" {
	
	ami = "${var.dsa_oraclelinux8_ami}"
	...
	tags = {
		Name = "${local.dsa_oraclelinux8_machine_name}"
...
output "dsa-oraclelinux8-id" {
  value = "${aws_instance.dsa_oraclelinux8_machine.id}"
}
