...
class InfraAutomation:
    ...
    def validate_processzone(self):
        print('\n=================================')
        print('Validating regression template...')
        ...
        if cmd_ret != 0:
            raise ChildProcessError('Failed to validate templates')
        else:
...
if __name__ == '__main__':
    ...
    infraAutomate.validate_processzone()
