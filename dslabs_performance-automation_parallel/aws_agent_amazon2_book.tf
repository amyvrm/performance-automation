resource "aws_instance" "dsa_amazon2_machine" {
	
	ami = "${var.dsa_amazon2_ami}"
	...
	tags = {
		Name = "${local.dsa_amazon2_machine_name}"
...
output "dsa-amazon2-id" {
  value = "${aws_instance.dsa_amazon2_machine.id}"
}
