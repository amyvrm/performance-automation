resource "aws_instance" "dsa_centos7_machine" {

	ami = "${var.dsa_centos7_ami}"
	...
	tags = {
		Name = "${local.dsa_centos7_machine_name}"
...
output "dsa-centos7-id" {
  value = "${aws_instance.dsa_centos7_machine.id}"
}
