resource "aws_instance" "dsa_oraclelinux7_machine" {
	
	ami = "${var.dsa_oraclelinux7_ami}"
	...
	tags = {
		Name = "${local.dsa_oraclelinux7_machine_name}"
...
output "dsa-oraclelinux7-id" {
  value = "${aws_instance.dsa_oraclelinux7_machine.id}"
}
