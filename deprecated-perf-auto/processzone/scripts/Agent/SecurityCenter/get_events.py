...
def main():
	...
	with requests.Session() as session:
		...
		try:
			...
			events = retrieveSystemEvents(client, sID, policy_id, args.rule)
			print(events)
...
def apply_rule_to_policy(client, sID, policy_name, rule):
	...
	identifiers.extend(['1008315', '1007588', '1007585', '1007538', '1005721', '1003783', '1001033', '1001001',
                                '1000834', '1000128', '1004715'])
...
def retrieveSystemEvents(client, sID, policy_id, rule):
    eventMessage = ""
    #timeRange = "LAST_HOUR"
    #timeRange = "LAST_24_HOURS"
    timeRange = "CUSTOM_RANGE"
    currtime = datetime.datetime.now(timezone.utc).replace(microsecond=0)
    lastoneminute = currtime - datetime.timedelta(minutes=1)
    ...
    hostFilter = {"hostGroupID":None, "hostID":None, "securityProfileID":policy_id, "type":"HOSTS_USING_SECURITY_PROFILE"}
